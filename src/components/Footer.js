...
const Footer = () => {
    ...
    return (
        ...
        <Whatsapp data-aos="flip-up" class="svg"fill = "#64dfdf" stroke="white" style={{width:"35%",height:"35%"}} /><p data-aos="zoom-out-up" style={{color:"white",opacity:0.8}}>+919665276786</p>
        </div>
        <div class="col-6" data-aos="flip-up">
        <Gmail data-aos="flip-up" class="svg" fill = "#64dfdf" stroke="white" style={{width:"35%",height:"35%"}} /><p data-aos="zoom-out-up" style={{color:"white",opacity:0.8}}>sharjeelarts@gmail.com</p>
        </div>
        </div>
